                            ...
                            !isPageBrands && (
                                ...
                                <div className="card-body">
                                    <ul className="list-unstyled">
                                        {error && <li className="alert alert-danger w-100" style={{ maxWidth: "100%" }}> Error: {error}</li>}
                                        {
                        ...
                        }
                        {
                            ...
                            >
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <ul className="list-unstyled">
                                            {isStatus.error && <li className="alert alert-danger w-100" style={{ maxWidth: "100%" }}> Error: {isStatus.error}</li>}
                                            {
