        ...
        <div className="accordion-collapse pl-filterBox">
          <div className="card">
            <div className="card-header" id="cardHeaderBrand">
              <h5>
                <a className="collapsed" onClick={toggleShowBrands}>
            ...
            >
              <div className="card-body">
                <ul className="list-unstyled">
                  {error && (
                    <li className="alert alert-danger m-0 w-100">
                      {" "}
                      Error: {error}
                    </li>
                  )}
                  {isLoading
                    ...
                    : brands &&
                      ...
                      brands.map((brand, index) => {
                        return (
                          <li key={`filter_sd_br_${index}`}>
                            <a className="pa-filter pa-filter-fast pa-filter-brand pa-filter-brand-782">
        ...
        <div className="accordion-collapse pl-filterBox">
          <div className="card">
            <div className="card-header" id="cardHeaderType">
              <h5 className="mb-0">
                <a onClick={toggleShowCategories} className="collapsed">
      ...
      <div className="accordion-collapse pl-filterBox">
        <div className="card">
          <div className="card-header" id="cardHeaderPriceRange">
            <h5>
              <a onClick={toggleShowPrice} className="collapsed">
